...
echo "# ----------------">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
echo "org.dbpedia.spotlight.data.labels=${ROOT_DIRECTORY}/dbpedia_data/3.9/${LANG_i18n}/labels_${LANG_i18n}.nt.bz2">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
echo "org.dbpedia.spotlight.data.redirects=${ROOT_DIRECTORY}/dbpedia_data/3.9/${LANG_i18n}/redirects_${LANG_i18n}.nt.bz2">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
echo "org.dbpedia.spotlight.data.disambiguations=${ROOT_DIRECTORY}/dbpedia_data/3.9/${LANG_i18n}/disambiguations_${LANG_i18n}.nt.bz2">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
echo "org.dbpedia.spotlight.data.instanceTypes=${ROOT_DIRECTORY}/dbpedia_data/3.9/${LANG_i18n}/instance_types_${LANG_i18n}.nt.bz2">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
echo "">> ../i18n/${LANG_i18n}/indexing_${DBPEDIA_VERSION}.properties
